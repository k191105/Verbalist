...
class _SettingsSheetState extends State<SettingsSheet> {
  ...
  Future<void> _openPaywall(String contextKey) async {
    final result = await openPaywall(context: context, contextKey: contextKey);
      ...
      child: ListView(
        ...
        children: themes.entries.map((entry) {
          ...
          return _buildSelectorTile(
            ...
            isPremium: isPremium,
            featureKey: EntitlementsService.premiumThemes,
            onTap: () async {
              setState(() {
              ...
              Analytics.instance.logEvent('USER_ACTION', {
                'paid_feature': 'settings_theme',
              });
              final isAllowed = await requireFeature(
                EntitlementsService.premiumThemes,
              );
              if (!mounted) {
                Analytics.instance.logEvent('APP_REACTION', {
                  'blocked': 'unmounted_context',
                });
                return;
              }
              ...
              if (isAllowed) {
                ...
                await _openPaywall('settings_theme');
              }
            },
          );
        }).toList(),
      ...
      child: ListView(
        ...
        children: fonts.entries.map((entry) {
          ...
          return _buildFontSelectorTile(
            ...
            isPremium: isPremium,
            featureKey: EntitlementsService.premiumFonts,
            onTap: () async {
              setState(() {
              ...
              if (isAllowed) {
                ...
                await _openPaywall('settings_font');
              }
            },
          );
        }).toList(),
